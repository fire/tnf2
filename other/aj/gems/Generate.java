...
public class Generate extends JPanel {
	...
	public static void drawNavet(Graphics g, Color c, int h, int w) {
		...
		int xxs[] = { (int) (1.0 * w / 4), (int) (1.0 * w / 2),
				(int) (1.0 * w * 3 / 4), (int) (1.0 * w / 2) };
		int yys[] = { (int) (1.0 * h / 2), (int) (1.0 * h / 4),
				(int) (1.0 * h / 2), (int) (1.0 * h * 3 / 4) };
	...
	public static void drawHex(Graphics g, Color c, int w, int h) {
		...
		int xs[] = { 0, (int) (1.0 * w / 3), (int) (1.0 * w * 2 / 3), w,
				(int) (1.0 * w * 2 / 3), (int) (1.0 * w / 3) };
		...
		int xxs[] = { (int) (w / 4), (int) (w / 3), (int) (w * 2 / 3),
				(int) (w * 3 / 4), (int) (w * 2 / 3), (int) (w / 3) };
		int yys[] = { (int) (h / 2), (int) (h * 3 / 4), (int) (h * 3 / 4),
				(int) (h / 2), (int) (h / 4), (int) (h / 4) };
		g.setColor(c.darker());
		g.fillPolygon(xxs, yys, xxs.length);
		g.setColor(c);
		g.drawPolygon(xxs, yys, xxs.length);
	...
	public static void drawSquare(Graphics g, Color c, int w, int h) {
		...
		g.drawLine(w, 0, 0, h);
		g.drawLine(0, 0, w, h);
		int xxs[] = { (int) (w / 4), (int) (w * 3 / 4), (int) (w * 3 / 4),
				(int) (w / 4) };
		int yys[] = { (int) (h / 4), (int) (h / 4), (int) (h * 3 / 4),
				(int) (h * 3 / 4) };
		g.setColor(c.darker());
