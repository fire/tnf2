...
public class Pong extends Header {
	...
	public Pong(byte[] b, byte[] payload, GnuProtocol gpp) {
		...
		ip = payload2[2] + "." + payload2[3] + "." + payload2[4] + "."
				+ payload2[5];
		numshareFiles = payload2[6] + payload2[7] * 256 + payload2[8] * 256
				* 256 + payload2[9] * 256 * 256 * 256;
		numshareKilobytes = payload2[10] + payload2[11] * 256 + payload2[12]
				* 256 * 256 + payload2[13] * 256 * 256 * 256;
	}
