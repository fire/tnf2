 ...
 * change the text in the field, the ChoiceField automatically finds the closest
 * match of possible choices and updates it self. When the choice field is
 * changed it generates an ActionEvent.
 * 
 * @author judda
...
public class ChoiceField extends TextField implements TextListener {
	...
	public static void main(String s[]) {
		String list[] = { "aaron", "aboard", "about", "above", "across",
				"along", "amid", "after", "arrow", "asexual", "another",
				"antidote", "all", "alot", "any", "about", "again", "abcde",
				"atlast" };
		Vector v = new Vector();
		for (int a = 0; a < list.length; a++) {
			v.addElement(list[a]);
