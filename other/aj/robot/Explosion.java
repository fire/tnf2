...
public class Explosion extends ArenaItem {
	...
	public void display(Graphics g) {
		...
		Color c = Arena
				.fade(Color.red, count, getTime(), Arena.MAXEXPLOSIONAGE);
		if (c == null)
			return;
		g.setColor(c);
		for (int a = 0; a < 4; a++) {
			int b = (int) Math.pow(2, a);
			g.drawOval((int) ((x - b * SIZE * arena.getScale() / 2)),
					(int) ((y - b * SIZE * arena.getScale() / 2)), (int) (b
							* SIZE * arena.getScale()), (int) (b * SIZE * arena
							.getScale()));
		}
	}
