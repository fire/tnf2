...
public class MapView extends JPanel {
	...
	public void setDisplayItems(Vector v) {
		displayItems = v;
	}
	...
	public void paint(Graphics G) {
		if (i == null || i.getWidth(this) != getWidth()
				|| i.getHeight(this) != getHeight()) {
		...
		g.translate(getWidth() / 2 - (int) myShip.x, getHeight() / 2
				- (int) myShip.y);
	...
	private void drawStars(Graphics g) {
		...
		for (int a = 0; a < 50; a++) {
			...
			Color c[] = { Color.red, Color.yellow, Color.lightGray, Color.blue,
