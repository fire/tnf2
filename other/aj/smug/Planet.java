...
public class Planet {
	...
	public Planet(String n,String l,double a,double t,double m,double i,String nic,int la,String typ,String go) {
		nick=nic;law=la;type=typ;gov=go;
		name=n;loc=l;agr=a;tech=t;min=m;ind=i;
	...
	public static Planet parse(GmlPair g) {
		...
		if (n!=null) nick=n.getString();
		String type="";
		n=g.getOneByName("type");
		if (n!=null) type=n.getString();
		String gov="";
		n=g.getOneByName("gov");
		if (n!=null) gov=n.getString();
		int law=1;
		n=g.getOneByName("law");
		if (n!=null) law=(int)n.getDouble();
		n=g.getOneByName("agr");
		if (n!=null) agr=n.getDouble();
		n=g.getOneByName("tech");
		if (n!=null) tech=n.getDouble();
		n=g.getOneByName("min");
		if (n!=null) min=n.getDouble();
		n=g.getOneByName("ind");
		if (n!=null) ind=n.getDouble();
	...
	public double getBaseMod(String s) {
		s=s.toUpperCase();
		if (s.equals("AGR")) return agr;
		if (s.equals("TECH")) return tech;
