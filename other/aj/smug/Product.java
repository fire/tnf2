...
public class Product {
	...
	public Product (String n,String b, boolean le,double c,boolean ha,String ni) {
		name=n;base=b;legal=le;cost=c;hazard=ha;nick=ni;
	}
	...
	public static Product parse(GmlPair g) {
		...
		if (n!=null) base=n.getString();
		String nick="";
		n=g.getOneByName("nick");
		if (n!=null) nick=n.getString();
		n=g.getOneByName("legal");
		if (n!=null) legal=(n.getString()).equalsIgnoreCase("true");
		n=g.getOneByName("hazard");
		if (n!=null) hazard=(n.getString()).equalsIgnoreCase("true");
	...
	public GmlPair toGml() {
		...
		v.addElement(g);
		if (!legal) {g=new GmlPair("legal",legal+"");v.addElement(g);}
		if (hazard) {g=new GmlPair("hazard",hazard+"");v.addElement(g);}
