...
public class Tokens {
	...
	Tokens(String s) {
		...
		while (s.length() > 0) {
			...
			} else if (s.toUpperCase().startsWith("FORALL")
					|| s.startsWith("-V")) {
				if (s.startsWith("-V")) {
			...
			} else if (s.toUpperCase().startsWith("OR") || s.startsWith("|")
					|| s.startsWith("+")) {
				if (s.startsWith("+")) {
			...
			} else if (s.toUpperCase().startsWith("AND") || s.startsWith("*")
					|| s.startsWith("&")) {
				if (s.startsWith("*")) {
					s = s.substring(1).trim();
				} else if (s.startsWith("&&")) {
			...
			} else if (s.toUpperCase().startsWith("IMP") || s.startsWith("==>")
