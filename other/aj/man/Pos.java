...
public class Pos {
	...
	public String toString() {
		return " h(" + headX + "," + headY + ") " + " n(" + neckX + "," + neckY
				+ ") " + " re(" + relbX + "," + relbY + ") " + " le(" + lelbX
				+ "," + lelbY + ") " + " rh(" + rhandX + "," + rhandY + ") "
				+ " lh(" + lhandX + "," + lhandY + ") " + " w(" + waistX + ","
				+ waistY + ") " + " rk(" + rkneeX + "," + rkneeY + ") "
				+ " lk(" + lkneeX + "," + lkneeY + ") " + " rf(" + rfootX + ","
				+ rfootY + ") " + " lf(" + lfootX + "," + lfootY + ") ";
	}
}
