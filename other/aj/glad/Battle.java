...
public class Battle {
	...
	public void doAttack(Gladator att) {
		...
		while (att.getNumberOfAttacks() > 0 && att.getStatus() == Gladator.ACTIVE) {
			...
			if (def == null) {
				System.out.println(att.getName() + " has nobody left to attack and ends his turn.");
				return;
			}
			def.chooseDef();
	...
	public void doAttack(Gladator att, Gladator def) {
		att.rollHit();
		if (att.getHit()) {
			if (att.getSpecialHit() && att.getSpecialType() == Plan.ANTIDODGE && def.defType() == Plan.DODGE) {
				def.rollDodge(att.getSpecialPoints());
			}
			else if (att.getSpecialHit() && att.getSpecialType() == Plan.ANTIPARRY && def.defType() == Plan.PARRY) {
				def.rollParry(att.getSpecialPoints());
			}
			else if (att.getSpecialHit() && att.getSpecialType() == Plan.ANTIBLOCK && def.defType() == Plan.BLOCK) {
	...
	public void doDamage(Gladator att, Gladator def) {
		...
		if (att.getSpecialHit() && att.getSpecialType() == Plan.DDOUBLE) {
			...
			def.hurt((Math.random() * 2 > 1 ? Gladator.RIGHTARM : Gladator.LEFTARM), dam);
		}
		else if (att.getSpecialHit() && att.getSpecialType() == Plan.LEG) {
			def.hurt((Math.random() * 2 > 1 ? Gladator.RIGHTLEG : Gladator.LEFTLEG), dam);
		}
	...
	public void reportDodged(Gladator att, Gladator def) {
		System.out.println(att.getName() + " attacked " + def.getName() + " with his " + att.mainWeapon.getName() + " and was Dodged.");
	}
	...
	public void reportParried(Gladator att, Gladator def) {
		System.out.println(att.getName() + " attacked " + def.getName() + " with his " + att.mainWeapon.getName() + " and was Parried by " + def.getName() + "'s " + def.mainWeapon.getName() + ".");
	}
	...
	public void reportBlocked(Gladator att, Gladator def) {
		System.out.println(att.getName() + " attacked " + def.getName() + " with his " + att.mainWeapon.getName() + " and was Blocked by " + def.getName() + "'s " + def.mainWeapon.getName() + ".");
	}
	...
	public void reportDodgedFailed(Gladator att, Gladator def) {
		System.out.print(att.getName() + " attacked and HIT " + def.getName() + " with his " + att.mainWeapon.getName() + " after " + def.getName() + "'s Dodge fail.");
	...
	public void reportParriedFailed(Gladator att, Gladator def) {
		System.out.print(att.getName() + " attacked and HIT " + def.getName() + " with his " + att.mainWeapon.getName() + " after " + def.getName() + "'s Parry fail.");
		reportPlayerStatus(def);
	}
	...
	public void reportBlockedFailed(Gladator att, Gladator def) {
		System.out.print(att.getName() + " attacked and HIT " + def.getName() + " with his " + att.mainWeapon.getName() + " after " + def.getName() + "'s Block fail.");
		reportPlayerStatus(def);
	}
	...
	public void reportHit(Gladator att, Gladator def) {
		System.out.print(att.getName() + " HIT " + def.getName() + " with his " + att.mainWeapon.getName() + ".");
		reportPlayerStatus(def);
	}
	...
	public void reportMissed(Gladator att, Gladator def) {
		System.out.println(att.getName() + " MISSED " + def.getName() + " with his " + att.mainWeapon.getName() + ".");
	}
	...
	public void reportSimoHitHit(Gladator att, Gladator def) {
		System.out.print(att.getName() + " and " + def.getName() + " SIMO both HIT.");
	...
	public void reportSimoHitMiss(Gladator att, Gladator def) {
		System.out.print(att.getName() + " and " + def.getName() + " SIMO, but only " + att.getName() + " HIT.");
		reportPlayerStatus(def);
	}
	...
	public void reportSimoMissHit(Gladator att, Gladator def) {
		System.out.print(att.getName() + " and " + def.getName() + " SIMO, but only " + def.getName() + " HIT.");
	...
	public void reportSimoMissMiss(Gladator att, Gladator def) {
		System.out.println(att.getName() + " and " + def.getName() + " SIMO, but both MISSED.");
	}
	...
	public void reportPlayerStatus(Gladator def, Gladator att) {
		System.out.println("  " + def.getName() + " took " + def.getLastHitDamage() + " to his " + def.getLastHitLocation() + " and " + att.getName() + " took " + att.getLastHitDamage() + " to his " + att.getLastHitLocation());
		if (att.getStatus() == Gladator.PASSOUT && def.getStatus() == Gladator.PASSOUT) {
			System.out.println("Both " + att.getName() + " and " + def.getName() + " pass out.");
		}
	...
	public void reportPlayerStatus(Gladator def) {
		System.out.println("  " + def.getName() + " took " + def.getLastHitDamage() + " to his " + def.getLastHitLocation() + ".");
