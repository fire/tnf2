...
public class Stuff {
	...
	public static void main(String s[]) {
		...
		System.out.println("result1 len="+test2.length()+" in "+(System.currentTimeMillis()-ti)+ "secs");
		if (test.length()<200) System.out.println("pretrim ="+test);
		if (test.length()<200) System.out.println("posttrim="+test2);
