...
public class Ceaser {
	...
	public static String common[] = { "a", "i", "it", "do", "is", "or", "me",
			"am", "to", "of", "we", "us", "if", "at", "who", "you", "him",
			"her", "run", "did", "not", "but", "and", "was", "has", "for",
			"from", "the", "hit", "try", "out", "can", "then", "when" };
	...
	public static void main(String SS[]) {
		...
		String num = "";
		if (all.indexOf(" ") > 0)
			num = all.substring(0, all.indexOf(" ")).trim();
		boolean isnum = true;
		try {
	...
	public static void doCeaser(String all) {
		for (int a = 0; a < 26; a++) {
			...
			if (test(s)) {
				System.out.println("Ceaser Shift (A=" + shift("A", a) + ") >"
						+ shift(all, a));
			}
		}
	}
