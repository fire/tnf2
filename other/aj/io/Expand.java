...
public class Expand {
	...
	public static void main (String s[]) {
		...
		try {
			...
			if (s.length == 2)br = new BufferedReader (new FileReader (s[1]));
			...
			try {
				...
				for (int a = 0; a < v.size(); a++) {
					...
					//System.err.println("ab="+ab+" a1="+(int)((a+1)*scale)+" a2="+(int)(a*scale));
					for (int b = 0; b < ab; b++) {
						for (int c = 0; c < w.length(); c++) {
							int cd = ((int) ((c + 1) * scale)) - ((int) (c * scale));
