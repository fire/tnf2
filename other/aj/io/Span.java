 ...
 *  smaller ones. Then it the files can be reconnected into the original. 
 *  Usefull for putting large files on a floppy disk. 
 *
 *@author     judda 
...
public class Span {
	 ...
	 *
	 *@param  Fin  Description of Parameter 
	 ...
	 *  Description of the Method 
	 *
	 *@param  Fout  Description of Parameter 
	 *@return       Description of the Returned Value 
	 */
	...
	public static void main (String argv[]) {
		if (argv.length > 3 || argv.length < 1) {
			...
			System.out.println ("FORMAT: java Span <sourcefile> <destfile> [chunkSize]");
