...
//recalc scan based on guessloc
  ...
  //int minscan = max (1, (int) (100 * 180.0 / 3.14159 / scandist))+1;
  int minscan = max (1, (int) (scanAge * 180.0 / 3.14159 / scandist));//adjusted for scandelay!=100
//printlog("\nlog minscan = %d",minscan);
  if (lastfound) {
    ...
    scandir += searchclock * (lastwid/2) * attemp;//adjust for expected position
    if (attemp % 2 == 0) {
